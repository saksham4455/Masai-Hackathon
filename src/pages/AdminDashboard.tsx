        ...
        <div className="p-3 space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'all' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:shadow-md'
              }`}
            >
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'status-pending' ? 'ring-2 ring-red-500 bg-red-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'status-progress' ? 'ring-2 ring-yellow-500 bg-yellow-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'status-resolved' ? 'ring-2 ring-green-500 bg-green-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'recent' ? 'ring-2 ring-indigo-500 bg-indigo-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center mb-1">
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'priority-critical' ? 'ring-2 ring-red-500 bg-red-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'priority-high' ? 'ring-2 ring-orange-500 bg-orange-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'priority-medium' ? 'ring-2 ring-yellow-500 bg-yellow-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`w-full bg-white rounded-lg shadow p-2 transition-all ${
                activeCard === 'priority-low' ? 'ring-2 ring-green-500 bg-green-50' : 'hover:shadow-md'
              }`}
            >
              <div className="flex justify-between items-center">
